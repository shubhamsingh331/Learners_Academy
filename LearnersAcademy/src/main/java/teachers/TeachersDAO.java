...
public class TeachersDAO {
	...
	public List<TeachersPojo> option() throws ClassNotFoundException, SQLException{
		Connection con = DbUtil.dbcon();
	...
	public int create(TeachersPojo teachers) throws ClassNotFoundException, SQLException {
		Connection con = DbUtil.dbcon();
		String sql = "create table ?(? int primary key, ";
		PreparedStatement ps = con.prepareStatement(sql);
		ps.setInt(1, teachers.getId());
		ps.setString(2, teachers.getFname());
		ps.setString(3, teachers.getLname());
